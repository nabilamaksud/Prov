...
function addIsFast(cars) {
   return { ...cars, isFast: true };
}
...
console.log(combineArrays([1, 2, 3], [4, 5, 6])); // Should log [1, 2, 3, 4, 5, 6]

console.log(addIsFast(car)); // Should log { name: "Volvo", speed: 120, isFast: true }
