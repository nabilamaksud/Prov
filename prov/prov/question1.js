...
console.log(howFast(20));   // Should log "Slow"
console.log(howFast(50));   // Should log "Medium"
console.log(howFast(100));  // Should log "Fixed"
console.log(howFast(25));   // Should log "Unknown"
